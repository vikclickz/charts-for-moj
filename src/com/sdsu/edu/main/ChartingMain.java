...
import com.sdsu.edu.main.ChartingTool.MyPickAdapter;
import com.sdsu.edu.main.ChartingToolStart.ChartTypeFrameGUI;

public class ChartingMain extends JFrame {
    ...
    JMenuItem attribitem = new JMenuItem("open attribute table", new ImageIcon("./src/data/tableview.gif"));
    JMenuItem createlayeritem = new JMenuItem("create layer from selection", new ImageIcon("./src/data/Icon0915b.jpg"));
    static JMenuItem promoteitem = new JMenuItem("promote selected layer", new ImageIcon("./src/data/promote.jpg"));
    JMenuItem demoteitem = new JMenuItem("demote selected layer", new ImageIcon("./src/data/demote.jpg"));
    JMenuItem printitem = new JMenuItem("print", new ImageIcon("./src/data/print.gif"));
    JMenuItem addlyritem = new JMenuItem("add layer", new ImageIcon("./src/data/addtheme.gif"));
    JMenuItem remlyritem = new JMenuItem("remove layer", new ImageIcon("./src/data/delete.gif"));
    JMenuItem propsitem = new JMenuItem("Legend Editor", new ImageIcon("./src/data/properties.gif"));
    JMenu helptopics = new JMenu("Help Topics");
    JMenuItem tocitem = new JMenuItem("Table of Contents", new ImageIcon("./src/data/helptopic.gif"));
    JMenuItem legenditem = new JMenuItem("Legend Editor", new ImageIcon("./src/data/helptopic.gif"));
    JMenuItem layercontrolitem = new JMenuItem("Layer Control", new ImageIcon("./src/data/helptopic.gif"));
    JMenuItem helptoolitem = new JMenuItem("Help Tool", new ImageIcon("./src/data/help2.gif"));
    JMenuItem contactitem = new JMenuItem("Contact us");
    JMenuItem aboutitem = new JMenuItem("About MOJO...");
    Toc toc = new Toc();
    String USAShp = "./src/data/states.shp";
    ...
    JButton addlyrjb = new JButton(new ImageIcon("./src/data/addtheme.gif"));
    JButton ptrjb = new JButton(new ImageIcon("./src/data/pointer.gif"));
    JButton distjb = new JButton(new ImageIcon("./src/data/measure_1.gif"));
    JButton XYjb = new JButton("XY");
    JButton helpjb = new JButton(new ImageIcon("./src/data/help2.gif"));
    JButton hotjb = new JButton(new ImageIcon("./src/data/hotlink.gif"));
    //add the button to the charting facility
    JButton chartjb = new JButton(new ImageIcon("./src/data/chart16.gif"));
    ...
    Image bolt = tk.getImage("./src/data/hotlink_32x32-32.gif");
